...
const notifyModels_1 = __importDefault(require("./notifyModels"));
const userModels_1 = __importDefault(require("../user/userModels"));
const app = express_1.default();
const notifyModels_2 = __importDefault(require("./notifyModels"));
...
exports.register = (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        const deviceInfo = yield deviceModel_1.default.findOne({ deviceId: req.body.deviceId });
        if (!deviceInfo) {
            req.body.userId = req.body.decoded._id;
            const db = new deviceModel_1.default(req.body);
            yield db.save();
            res.status(201).send({
                success: true,
                data: db
            ...
            const deviceData = yield deviceModel_1.default.findOneAndUpdate({ deviceId: req.body.deviceId }, {
                $set: {
...
exports.sendNotification = (obj, info, token, cb) => {
    ...
    const body = {
        ...
        // },
        "data": Object.assign({ "type": obj.notificationtype, "tab": "HomePage", "link": "https://fcm.googleapis.com/fcm/send", "title": obj.title, "message": obj.content }, sendData),
        "priority": "high",
...
exports.removeDevice = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        if (req.body.deviceId) {
            const deviceInfo = yield deviceModel_1.default.remove({ deviceId: req.body.deviceId });
            if (deviceInfo) {
...
exports.getAllNotifications = (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        yield notifyModels_2.default.find({ userId: req.body.decoded._id }, (err, data) => __awaiter(this, void 0, void 0, function* () {
            console.log(`user:----`, err, data);
            if (data) {
                const count = yield notifyModels_2.default.count({ userId: req.body.decoded._id });
...
exports.userReply = (req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log("hello");
    try {
        ...
        const userData = yield userModels_1.default.findOne({ email: req.body.decoded.email }, { userName: 1, picture: 1 });
        console.log("UserData----->", userData);
        const notificationData = yield notifyModels_2.default.find({ _id: "5b334e9778f1b23454da4b6d" });
        ...
        const allData = new notifyModels_1.default({
...
exports.Test = (req, res) => __awaiter(this, void 0, void 0, function* () {
    console.log("hello");
    try {
        const userData = yield userModels_1.default.find({});
        console.log("hello", userData);
        let data = yield userData.map((record, index) => __awaiter(this, void 0, void 0, function* () {
            if (typeof record.picture == "string") {
                let url = record.picture.split("/");
                let picture = url[url.length - 1];
                let data = yield userModels_1.default.findOneAndUpdate({ _id: record._id }, { $set: { picture: picture } });
                console.log(data);
            }
        }));
...
//# sourceMappingURL=notifyControllers.js.map